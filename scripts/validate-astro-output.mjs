...
assert.match(home, /support-mobile-fix\.css\?v=20260907-mobile2/);
assert.match(home, /support-mobile-fix\.js\?v=20260907-mobile2/);
...
assert.match(supportLanding, /support-mobile-fix\.css\?v=20260907-mobile2/);
assert.match(supportLanding, /support-mobile-fix\.js\?v=20260907-mobile2/);
